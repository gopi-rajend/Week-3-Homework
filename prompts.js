...
export const DEFAULT_PROMPTS = {
 ...
 /**
   * Test Data Generator Prompt (Java)
   */
  TEST_DATA_GENERATOR: `
    Instructions:
    - Generate ONLY test data based on the selected fields in the DOM.
    - Each field should have multiple test data.
    - LIMIT the number of rows to 10.
    - Use realistic dataset (names, addresses, pin codes, mobile numbers).
...
|---------------|----------------------------------|----------|---------------|-----------|------------|------------------|--------------------|
| Ayesha Khan   | 14 Indiranagar, Bangalore        | 560038   | 9876543210    | Bangalore | Chennai    | 13 Sep, 2025     | Yes                |
  ...
  PLAYWRIGHT_TYPESCRIPT_PAGE_ONLY: `
    ...
    - Add TSDoc comments for methods & class.
...
export class ComponentPage {
  ...
  // Add methods as per the DOM
    ...
    Output Format:
    - A single Java class inside a \`\`\`ts\`\`\` block.
